        ...
        <div id="home" className="flex w-full h-screen flex-col md:flex-row gap-5 items-center justify-center text-white relative">
            ...
            <div className='md:w-3/6' data-aos="fade-right" data-aos-duration="1000" data-aos-offset="100" >
                <div className="flex flex-col w-full mt-8">
                    ...
                    <h1 className="text-2xl font-bold">Emmanuel Kipruto</h1>
                    <p class="text-xl font-bold text-gray-300">AI-First Software Engineer</p>
                    <p className="text-md font-light text-gray-400 ">Enthusiastic and motivated self-learning in Information Technology. Interested in exploring about Computer Network,Cloud Computing, DevSecops, and Software Development. Now I am looking for more experience in my field while bringing Specific Autonomous Business Solutions From My Ai Agency.</p>
                </div>
